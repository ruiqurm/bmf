...
#define BMF_PROTECT(...)                                                       \
    try {                                                                      \
        ...
        s_bmf_last_error2 = e.what();                                           \
    }

using namespace bmf_sdk;

thread_local std::string s_bmf_last_error2;

void bmf_set_last_error(const char *errstr) { s_bmf_last_error2 = errstr; }

const char *bmf_last_error() { return s_bmf_last_error2.c_str(); }
